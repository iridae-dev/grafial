...
use crate::frontend::ast::{ActionStmt, ExprAst, PatternItem};
...
impl From<&crate::frontend::ast::RuleDef> for RuleIR {
    fn from(rule: &crate::frontend::ast::RuleDef) -> Self {
        Self {
...
mod tests {
    ...
    fn rule_ir_from_rule_def() {
        let rule_def = RuleDef {
            ...
            actions: vec![ActionStmt::ForceAbsent { edge_var: "e1".into() }],
            mode: None,
        };
