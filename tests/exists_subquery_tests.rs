...
fn exists_subquery_finds_matching_edge() {
    ...
    let _e2 = g.add_edge(n1, n3, "REL".into(), BetaPosterior { alpha: 1.0, beta: 9.0 });
    ...
    let rule = RuleDef {
        ...
        where_expr: Some(ExprAst::Binary {
            ...
            right: Box::new(ExprAst::Exists {
                pattern: PatternItem {
                    src: NodePattern { var: "A".into(), label: "Person".into() },
                    edge: EdgePattern { var: "ax".into(), ty: "REL".into() },
                    dst: NodePattern { var: "X".into(), label: "Person".into() },
                },
...
fn not_exists_subquery_filters_matches() {
    ...
    let e1 = g.add_edge(n1, n2, "REL".into(), BetaPosterior { alpha: 9.0, beta: 1.0 });
    let _e2 = g.add_edge(n1, n3, "REL".into(), BetaPosterior { alpha: 8.0, beta: 2.0 });
    ...
    let rule = RuleDef {
        ...
        where_expr: Some(ExprAst::Exists {
            pattern: PatternItem {
                src: NodePattern { var: "A".into(), label: "Person".into() },
                edge: EdgePattern { var: "ac".into(), ty: "REL".into() },
...
fn exists_subquery_with_variable_constraint() {
    ...
    // Create edges: n1 -> n2, n1 -> n3
    let e1 = g.add_edge(n1, n2, "REL".into(), BetaPosterior { alpha: 9.0, beta: 1.0 });
    let e2 = g.add_edge(n1, n3, "REL".into(), BetaPosterior { alpha: 8.0, beta: 2.0 });
